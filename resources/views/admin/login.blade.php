...
<body style="background-image: url('{{ asset('images/ncardbg.png')}}'); background-attachment: fixed;  background-size: 100%;">
    <div class="container">
        <div class="row my-3">
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form action="{{ route('signin') }}" autocomplete="on" method="post" role="form"
                                ...
                                <h3>
                                    <img src="{{ asset('images/ncardlogo.png') }}" alt="NIDC" style="height:90px;">
                                </h3>
                                <!-- CSRF Token -->
